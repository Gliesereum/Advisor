...
public class ArtBond {
    ...
    private Object paymentDuration;

    @SerializedName("location")
    private String location;

    @SerializedName("paymentCalendar")
    private List<Object> paymentCalendar;
    ...
    public void setNkd(Object nkd) {
        this.nkd = nkd;
    }

    public Object getNkd() {
        return nkd;
    }
    ...
    public void setPercentPerYear(Object percentPerYear) {
        this.percentPerYear = percentPerYear;
    }

    public Object getPercentPerYear() {
    ...
    public void setPaymentDuration(Object paymentDuration) {
        this.paymentDuration = paymentDuration;
    }

    public Object getPaymentDuration() {
    ...
    public void setPaymentCalendar(List<Object> paymentCalendar) {
        this.paymentCalendar = paymentCalendar;
    }

    public List<Object> getPaymentCalendar() {
